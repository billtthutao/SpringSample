...
public class T3 {
	...
	public T3() throws TeamRepositoryException {
			loginHandler = new LoginHandler("taohu@cn.ibm.com","billtt012027033");
			TeamPlatform.startup();
			teamRepository = TeamPlatform.getTeamRepositoryService().getTeamRepository("https://igartc02.swg.usma.ibm.com/jazz");
	...
	public HashSet<WorkItem> getWorkItemByStatus(String status) {
	...
	public static void main(String[] args) throws TeamRepositoryException {
		T3 t3 = new T3();
		System.out.println(t3.getWorkItemByStatus("1"));
	}
